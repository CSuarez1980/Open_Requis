...
Public Class Form1
    ...
    Private Sub BGOR_L7P_DoWork(ByVal sender As System.Object, ByVal e As System.ComponentModel.DoWorkEventArgs) Handles BGOR_L7P.DoWork
        ...
        For Each row As DataRow In dtPlants.Rows
            Dim Rep As New SAPCOM.OpenReqs_Report(SAP, "CF9019", "LAT") ' -> Change TNumber; use machine owner, password is taken from LA Tool Password setup @ System menu/Variants/SAP Passwords
            ...
            If Rep.Success Then
                If Rep.ErrMessage = Nothing Then
                    ...
                    Dim Eban As New SAPCOM.EBAN_Report(SAP, "CF9019", "LAT") ' -> Change TNumber; use machine owner, password is taken from LA Tool Password setup @ System menu/Variants/SAP Passwords
                    ...
                    If Eban.Success Then
                        For Each R As DataRow In POs.Rows
                            ...
                            If Price_Is_Valid AndAlso xPrice > 0 Then
                                ...
                                R("Currency") = rCurr(0)
                            Else
                                Dim Try2 As New SAPCOM.PRInfo(SAP, "CF9019", "LAT", R("Req Number")) ' -> Change TNumber; use machine owner, password is taken from LA Tool Password setup @ System menu/Variants/SAP Passwords
